...
public class AWSLambdaClient {
    ...
    public static String callLambda(Map<String, Object> payload) throws Exception {
        ...
        String jsonInputString = new ObjectMapper().writeValueAsString(payload);
    ...
    public static CompletableFuture<String> callLambdaAsync(Map<String, Object> payload) {
